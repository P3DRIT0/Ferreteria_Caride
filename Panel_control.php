                    ...
                    <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark">
                        <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                            ...
                            <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                                <li class="nav-item">
                                    <a href="Ferreteria_Caride.html" class="nav-link align-middle px-0">
            ...
            <div class="card">
              ...
              <div class="panel-content">
                ...
                <table id="dtable" class="table">
                  <tr>
                    <td><span class="badge badge-info bg-dark">12</span> <a href="#">Lorem ipsum dolor sit amet, consectetur adipisicing elit.</a></td>
                    <td><span class="bi bi-calendar-week-fill"></span> 01.13.16</td>
                  </tr>
                  <tr>
                    <td><span class="badge badge-info bg-dark">12</span> <a href="#">Lorem ipsum dolor sit amet, consectetur adipisicing elit.</a></td>
                    <td><span class="bi bi-calendar-week-fill"></span> 01.13.16</td>

    ...
    <body>
        ...
        <main id="fullpage">
            ...
            <header class="section productos">
                ...
                <article class="slide">
                    <div class="informacion-producto">
                        <p class="modelo">
                            <span class="texto-blanco">Fontanería</span>
                        </p>
            ...
            <section class="section novedades">
                ...
                <div id="contenedor-novedades" class="contenedor-novedades">
                    ...
                    <div class="row row-cols-1 row-cols-md-3 g-4">
                        <div class="col">
                            <div class="card">
                                <img src="https://ferreteria.es/media//catalog/category/cache/250x250/M/u/Muebles_de_jardin_1.jpg" style="height: 230px;" class="card-img-top" alt="..." />
                                <div class="card-body">
                                    <h5 class="card-title">Promoción Jardín 2021</h5>
                                    <p class="card-text">
                        ...
                        <div class="col">
                            <div class="card">
                                <img src="https://www.todoestufas.click/media/todoestufas/images/2021/01/26/2021012611430096262.jpg" class="card-img-top" style="height: 230px;" alt="..." />
                                <div class="card-body">
                        ...
                        <div class="col">
                            <div class="card">
                                <img src="https://static3.elcorreo.com/www/multimedia/202104/23/media/cortadas/carros_peque-k9HD-U140146058374fTD-624x385@RC.jpg" class="card-img-top" style="height: 230px;" alt="..." />
                                <div class="card-body">
                                    <h5 class="card-title">Carritos de la compra</h5>
                                    <p class="card-text">
                                        This is a longer card with supporting text below as a natural lead-in to additional content.
                                        <br><a href="#" class="btn btn-primary">Seguir leyendo</a>
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card">
                                <img src="https://i0.wp.com/ferreteriacaride.es/wp-content/uploads/2019/11/Ferreteria-Caride-Oferta-Profesional-Oto%C3%B1o-2019.jpg?w=360&ssl=1" style="height: 230px;" class="card-img-top" alt="..." />
                                <div class="card-body">
                                    <h5 class="card-title">Promocion profesional 2021</h5>
                                    <p class="card-text">
                                        This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.
                                        <br><a href="#" class="btn btn-primary">Seguir leyendo</a>
                                    </p>
                        ...
                        <div class="col">
                            <div class="card">
                                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSh26eB7I98JrBh5ozbdM7n--B3U7vlXV5O8w&usqp=CAU" style="height: 230px;" class="card-img-top" alt="..." />
                                <div class="card-body">
                                    <h5 class="card-title">Escaleras Rolser</h5>
                                    <p class="card-text">
                                        This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.
                                        <br><a href="#" class="btn btn-primary">Seguir leyendo</a>
        ...
        <script>
            ...
            function cargar_categoria() {
                ...
                if (tipo === "Fontaneria") {
                    $("#lista").append(
                        "<li id='Fontaneria1'>Tubería extracción gases y calentadores.</li><li id='Fontaneria2'>Tubería cobre, polietileno, Pb, multicapa y racorería en latón.</li><li id='Fontaneria3'>Tubería PVC, canalón y accesorios</li><li id='Fontaneria4'>Grifería</li><li id='Fontaneria5'>Motores y bombas pozo</li><li id='Fontaneria6'>Accesorios Baño, manuales, soportes, barras y alfombras ducha</li>"
                    );
                }
                if (tipo === "Pintura") {
                    $("#lista").append(
                        "<li id='pintura1'>Pinturas plásticas de interior y exterior.</li><li id='pintura2'>Pinturas en spray</li><li id='pintura3'>Tratamientos para la madera</li><li id='pintura4'>Disolventes y gran variedad de productos complementarios</li><li id='pintura5'>Rodillos, pinceles, cintas y lija entre otros</li>"
                    );
                }
                if (tipo === "Electrico") {
                    $("#lista").append(
                        "<li  id='electrico1'>Elementos eléctricos Simon-27</li><li id='electrico2'>Cajas de montaje y derivación</li><li id='electrico3'>Corrugados</li><li id='electrico4'>Cable de linea hasta 10mm y mangueras de dos, tres o cuatro hilos</li><li id='electrico5'>Canaleta</li><li id='electrico6'>Magnetotérmicos y diferenciales</li><li id='electrico7'>Pequeño material para la mayoría de las necesidades habituales</li>"
                    );
                }
                if (tipo === "Hogar") {
                    $("#lista").append(
                        "<li id='hogar1'>Menaje de cocina metálico y plástico</li><li id='hogar2'>Vinilos adhesivos</li><li id='hogar3'>Hules</li><li id='hogar4'>Amplio surtido de tendales de ropa</li>"
                    );
                }
                if (tipo === "Construccion") {
                    $("#lista").append(
                        "<li id='construccion1'>Morteros, cementos cola y escayolas</li><li  id='construccion2'>Ladrillo</li><li  id='construccion3'>Telas asfálticas, poliexpand</li><li  id='construccion4'>Planchas fibra cubiertas y sujecciones</li>"
                    );
                }
            }
            ...
            /*Cambio de las imagenes  de los productos de la ferretería*/
